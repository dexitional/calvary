...
function Statistics() {
  return (
    <div className="w-full bg-[#086ecd]">
        <div className="mx-auto py-4 md:py-0 px-6 md:h-24 w-full max-w-6xl grid grid-cols-1 md:grid-cols-4 gap-4 md:gap-10 place-content-center divide md:divide-y-0 divide-y-2 divide-dashed divide-slate-50/30">
