  ...
  return (
    <div className="z-1 relative w-full h-36 md:h-72 overflow-hidden">
        ...
        <div className="z-30 h-full flex flex-col items-center justify-center">
          <span className="z-40 text-center text-sm text-white font-semibold"> <br/><span className="text-xl md:text-3xl font-extrabold border-white bg-gradient-to-r from-white via-green-50 to-white bg-clip-text text-transparent">HEALING</span></span>
